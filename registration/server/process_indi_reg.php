...
$insert_query="INSERT into individual_events(clg_name,dept_name,mail,phone,transaction_id,event_name,event_id,name) values('$clg','$dpt_name','$mail','$phn','$trans_id','$event_name','$event_id','$name')";
try {
    // Execute the query
